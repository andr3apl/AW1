...
function Question(text, questioner, date) {
    ...
    this.findAll = (name) => {
        return this.list.filter((e) => e.respondent === name);
    }
...
const q = new Question('Best way of enumerating an array in JS', 'E.Masala', dayjs('2024-02-28'));
const ans1 = new Answer('For of', 'Andrea', 3, dayjs('2024-04-02'));
